...
export default function DetallesProductoTablet({proporcional}) {
    ...
    return (
        <div className='' style={{width: '100%', height: 'auto'}}>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 50 / proporcional, marginBottom: 10 / proporcional}}>
                ...
                <div style={{width: '40%', height: 50 / proporcional}}>
            ...
            <div style={{width: '100%', height: 60 / proporcional, marginBottom: 20 / proporcional}}>
                <div className='d-flex' style={{width: '100%', height: 60 / proporcional}}>
                    ...
                    <div className='d-flex justify-content-end' style={{width: '49%', height: 40 / proporcional, marginTop: 10 / proporcional, marginBottom: 10 / proporcional}}>
