...
export default function ModalProductoTablet({proporcional}) {

    const dispatch = useDispatch ()

    return (
        <div className='position-absolute top-0 start-0' style={{width: '100%', height: '100%', background: 'rgb(39, 39, 39, 0.6)'}}>
            <div className='position-fixed top-50 start-50 translate-middle shadow rounded' style={{width: 900 / proporcional, height: 460 / proporcional, background: 'white', zIndex: 9999}}>
