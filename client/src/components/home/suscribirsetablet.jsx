...
export default function SuscribirseTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 120 / proporcional, marginTop: 50 / proporcional, background: 'rgb(255, 210, 0)', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional }}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 120 / proporcional}}>
                <div style={{width: '32%', height: 120 / proporcional}}>
                    <div className='d-flex' style={{width: '100%', height: 40 / proporcional, marginTop: 39 / proporcional, marginBottom: 39 / proporcional}}>
                        <img src={icono_email} style={{width: 40 / proporcional, height: 40 / proporcional, marginRight: 10 / proporcional}}/>
                        <p className='' 
                            style={{fontSize: 20 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0 / proporcional, color: 'black',
                                    fontWeight: 400, fontFamily: 'Merriweather Sans, sans-serif', cursor: 'default', textAlign: 'left'}}>
                            Suscríbete a nuestro<br/> boletín.
                        </p>
                    </div>
                </div>

                <div className='d-flex justify-content-between' style={{width: '43%', height: 110 / proporcional, paddingTop: 30 / proporcional, paddingBottom: 30 / proporcional}}>
                    <input  
                        type='email'
                        className='form-control border-0 rounded-pill'
                        style={{width: '60%', height: 50 / proporcional, background: 'white', color: 'black', fontSize: 16 / proporcional, fontFamily: 'Merryweather Sans, sans-serif'}}
                    ...
                    <button className='btn rounded-pill' style={{width: '38%', height: 50 / proporcional, background: boton_suscribirse ? 'black' : '#4a9ae9', fontSize: 16 / proporcional,
                ...
                <div style={{width: '25%', height: 110 / proporcional}}>
