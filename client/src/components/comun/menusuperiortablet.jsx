...
export default function MenuSuperiorTablet({proporcional}) {
    ...
    return (
        <div className='' style={{width: '100%', height: 'auto', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional, zIndex: 9999}}>
            <div className='d-flex' style={{width: '100%', height: 100 / proporcional}}>
                <div className='d-flex justify-content-start' style={{width: '50%', height: 100 / proporcional}}>
                    <p className='' 
                ...
                <div className='d-flex justify-content-end' style={{width: '50%', height: 100 / proporcional}}>
                ...
                <div className='' style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <div className='' style={{width: '20%', height: 'auto'}}>
                            <p className='' 
                                style={{fontSize: 18 / proporcional, lineHeight: `${'auto'}px`, marginBottom: 0 / proporcional, 
                                        ...
                                        fontFamily: 'Lora, serif', cursor: 'pointer', textAlign: 'center', height: 'auto'}}
                        ...
                        <div className='position-relative' style={{width: '20%', height: 'auto'}}
                            ...
                            </div>
                            {
                                seleccion_menu === 'categorias' ? (
                                    <div className='position-absolute shadow rounded' style={{width: 900 / proporcional, height: 'auto', background: 'white', 
                                            zIndex: 99999, left: -365 / proporcional, top: 'auto'}}>
                                        <div className=''  style={{width: '100%', height: 'auto'}}>
                                            ...
                                            <div style={{width: '100%', height: 'auto', padding: 30 / proporcional, background: '#fafafa'}}>
                                                <p className='' 
