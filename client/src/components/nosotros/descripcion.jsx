...
export default function Descripcion({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional}}>
            <div className='d-flex justify-content-center' style={{width: '100%', height: 60 / proporcional, borderBottom: '1px solid rgb(229, 229, 229)'}}>
                <div className='d-flex justify-content-center' style={{width: '20%', height: 60 / proporcional, border: seleccion_menu === 'desarrollo' ? '1px solid rgb(229, 229, 229)' : 'none',
                ...
                <div className='d-flex justify-content-center' style={{width: '20%', height: 60 / proporcional, border: seleccion_menu === 'equipo' ? '1px solid rgb(229, 229, 229)' : 'none',
                ...
                <div className='d-flex justify-content-center' style={{width: '20%', height: 60 / proporcional, border: seleccion_menu === 'estrategia' ? '1px solid rgb(229, 229, 229)' : 'none',
