...
export default function CaracteristicasAdicionalesTablet({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 80 / proporcional, borderBottom: '1px solid rgb(189, 189, 189)'}}>
                    <div style={{width: '20%', height: 80 / proporcional, paddingTop: 10 / proporcional, paddingBottom: 10 / proporcional,
