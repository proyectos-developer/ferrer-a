    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div className='d-flex' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                <div style={{width: '45%', height: 50 / proporcional}}>
                    <p className='' 
                        style={{fontSize: 16 / proporcional, lineHeight: `${25 / proporcional}px`, marginBottom: 0 / proporcional, color: 'rgb(102, 102, 102)',
                                fontWeight: 400, fontFamily: 'Merriweather Sans, sans-serif', cursor: 'default', textAlign: 'left'}}>
                        Mostrando 1 -12 de 24 <br/> resultados
                    </p>
                </div>
                <div className='d-flex justify-content-end' style={{width: '55%', height: 50 / proporcional}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                <button className='btn rounded-pill' style={{width: 250 / proporcional, height: 50 / proporcional, background: boton_cargar ? '#4a9ae9' : 'rgb(255, 210, 0)', 
