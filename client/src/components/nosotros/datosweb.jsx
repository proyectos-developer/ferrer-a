...
export default function DatosWeb({proporcional}) {

    return (
        <div className='position-relative' style={{width: '100%', height: 400 / proporcional, paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional, paddingLeft: 300 / proporcional, paddingRight: 300 / proporcional,
